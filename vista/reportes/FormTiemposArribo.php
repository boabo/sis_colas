...
?>
<script>
    Phx.vista.FormTiemposArribo = Ext.extend(Phx.frmInterfaz, {
        ...
        constructor: function(config) {
            ...
            Phx.vista.FormTiemposArribo.superclass.constructor.call(this, config);
            this.init();
            this.iniciarEventos();

        },
        title : 'Reporte de Tiempos de Arribo',
        topBar : true,
        botones : false,
        remoteServer : '',
        labelSubmit : 'Generar',
        tooltipSubmit : '<b>Generar Reporte de Tiempos de Arribo</b>',
        tipo : 'reporte',
        clsSubmit : 'bprint',
        Grupos : [{
            layout : 'column',
        ...
        onSubmit: function(){
            if (this.form.getForm().isValid()) {
                ...
                Phx.CP.loadWindows('../../../sis_colas/vista/reportes/GridTiemposArribo.php', 'Tiempos de arribo : '+data.desc_sucursal, {
                    width : '90%',
                    height : '80%'
                }, data	, this.idContenedor, 'GridTiemposArribo')
            }
        },
        desc_item:''
