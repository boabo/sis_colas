...
?>
<script>
    Phx.vista.FormCuadroI = Ext.extend(Phx.frmInterfaz, {
        ...
        constructor: function(config) {
            ...
            Phx.vista.FormCuadroI.superclass.constructor.call(this, config);
            this.init();
            this.iniciarEventos();

        },
        title : 'Reporte de Cuadro I',
        topBar : true,
        botones : false,
        remoteServer : '',
        labelSubmit : 'Generar',
        ...
        onSubmit: function(){
            if (this.form.getForm().isValid()) {
                ...
                Phx.CP.loadWindows('../../../sis_colas/vista/reportes/GridCuadroI.php', 'Tiempos de arribo : '+data.desc_sucursal, {
                    width : '90%',
                    height : '80%'
                }, data	, this.idContenedor, 'GridCuadroI')
            }
        },
        desc_item:''
