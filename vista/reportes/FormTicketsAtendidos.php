...
<script>
	Phx.vista.FormTicketsAtendidos = Ext.extend(Phx.frmInterfaz, {
		...
		title : 'Reporte Tickets Atendidos',
		topBar : true,
		botones : false,
		remoteServer : '',
		labelSubmit : 'Generar',
		tooltipSubmit : '<b>Generar Reporte de Tickets Atendidos</b>',
		tipo : 'reporte',
		clsSubmit : 'bprint',
		Grupos : [{
			layout : 'column',
		...
		onSubmit: function(){
			if (this.form.getForm().isValid()) {
				...
				Phx.CP.loadWindows('../../../sis_colas/vista/reportes/GridTicketsAtendidos.php', 'Tickets Atendidos: '+data.desc_sucursal, {
						width : '90%',
						height : '80%'
					}, data	, this.idContenedor, 'GridTicketsAtendidos')
			}
		},
		desc_item:''
