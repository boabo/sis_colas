...
?>
<script>
    Phx.vista.GridTicketsAtencion = Ext.extend(Phx.gridInterfaz, {
        constructor : function(config) {
            this.maestro = config;
            this.sucursal = this.desc_sucursal;

            Phx.vista.GridTicketsAtencion.superclass.constructor.call(this, config);
            this.init();
            this.load({
                params : {
                    start: 0,
        ...
        ActList : '../../sis_colas/control/Reporte/listarTicketAtencion',
        id_store : 'id_ficha',
        fields : [{
            name : 'id_ficha'
        }, {
