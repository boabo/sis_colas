...
?>
<script>
    Ext.define('Phx.vista.PromedioAtencionEstado',{
        ...
        constructor: function(config) {
            ...
            this.store = new Ext.data['JsonStore']({
                url: '../../sis_colas/control/Ficha/reporteTiempoAtencionEstado',
                id: 'id_ficha',
                //root: 'datos',
                sortInfo: {field: 'id_ficha',direction: 'ASC'},
                totalProperty: 'total',
                fields:['estado','promedio_estado'],
                remoteSort: true
            });
            ...
            this.chart = Highcharts.chart('map-'+this.idContenedor, {
                ...
                title: {
                    text: "Por Promedio Atencion Estado"
                },
                tooltip: {
        ...
        cargarChart: function(resp){
            ...
            reg.datos.forEach(function(element) {
                ...
                resul.push({
                    ...
                    name: element.estado,
                    descripcion:'',
                    y:parseFloat(element.promedio_estado)
                });
